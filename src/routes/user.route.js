...
api.get('/findTeamId/:idTeam',teamController.findTeamId)
api.get('/pdfTeamsByLeague/:idLeague', md_authentication.ensureAuth, teamController.pdfTeamsByLeague);
...
api.post('/addMatchAdmin/:idLeague',md_authentication.ensureAuth,matchController.addMatchAdmin)
